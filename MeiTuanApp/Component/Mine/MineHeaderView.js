/**
 * Created by FineexMac on 2017/9/18.
 */
    ...
    renderTopView(){
        return(
            <View style={styles.topViewStyle}>
                <Image source={{uri: 'hot_wash'}} style={styles.leftIconStyle}/>
                <View style={styles.centerViewStyle}>
                    <Text style={{fontSize:18, color:'white', fontWeight:'bold'}}>美团ReactNative</Text>
